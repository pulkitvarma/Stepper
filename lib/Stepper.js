...
_createClass(Stepper, [{
  ...
  value: function componentDidMount() {
    ...
    var x = document.getElementsByClassName('stepper-item-inner-active')[0].parentElement;
    x.classList.add('sizeparent');

    for (var i = 1; i < state.activeStep; i++) {
      document.getElementsByClassName(i.toString())[0].classList.add('completed');
    }

    for (var i = 0; i < state.completed; i++) {
      document.querySelectorAll('.stepper-item-inner')[i].classList.add('step-completed');
      var _x = document.getElementsByClassName('step-completed')[0].parentElement;

      _x.classList.add('completedCheck');
    }
  }
},{
