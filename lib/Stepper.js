...
},
{
  ...
  return _react.default.createElement("div", {
    ...
    type: "button",
    className: this.state.activeStep === this.props.steps.length ? "finish-button" : "next-button",
    value: this.state.activeStep === this.props.steps.length ? 'Finish' : 'Next',
    onClick: this.state.activeStep === this.props.steps.length ? this.handleFinish : this.handleOnNextClick
  }))));
}
}]);
